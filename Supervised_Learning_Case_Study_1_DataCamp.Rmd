---
title: "Predicting Fuel Efficiency From a US Department of Energy Data Set for real cars of 2018"
author: "Ketan Bhadoriya"
output: html_document
---

######*Data Taken from Datacamp.com from a Supervised Learning Course and Case Study performed under the guidance of the Tutor Julia Silge Data Scientist at Stack Overflow.*
...
**Conclusion : Here in case of training data ;from R^2 value (near 1 for rf), we can see that Random Forest is more accurate than linear regression model.**
...
```
**Conclusion : Here in case of testing data too ;from R^2 value (near 1 for rf), we can see that Random Forest is more accurate than linear regression model.**
...
**Conclusion : We can Predict Fuel Effieincey more accurately with Random Forest Model**